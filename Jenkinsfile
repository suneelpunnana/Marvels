    ...
    stages {
        ...
        stage('Pushing to Nexus'){
            steps{
                    ...
                    sh 'curl -F file=@target/Calc-${BUILD_NUMBER}.war -u ${username}:${password} http://${nexus_url}/nexus/content/repositories/devopstraining/comrades/Calc-${BUILD_NUMBER}.war'
            }
        }
